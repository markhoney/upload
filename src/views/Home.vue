...
<script>
	...
	export default {
		...
		methods: {
			upload(file) { // Upload an Excel file
				...
				this.filename = file.name; // Grab the uploaded filename (we don't use this at the moment, but it might be useful as the download filename)
				reader.readAsArrayBuffer(file); // Read the loaded file
			},
